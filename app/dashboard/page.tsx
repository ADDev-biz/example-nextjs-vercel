    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="stat-figure text-accent">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M5 8h14M5 8a2 2 0 110-4h1.586a1 1 0 01.707.293l1.414 1.414a1 1 0 00.707.293h11.172a1 1 0 01.707.293l1.414 1.414a1 1 0 00.707.293H19a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"
              ></path>
            </svg>
          </div>
        ...
        <div className="stat bg-base-100 rounded-lg shadow">
          ...
          <div className="stat-desc">Compared to last year</div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="flex items-center gap-4 p-3 bg-base-200 rounded-lg">
                <div className={`badge badge-${activity.type} badge-sm`}></div>
